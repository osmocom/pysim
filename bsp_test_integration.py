    ...
    def verify_bound_profile_package(self,
        ...
        try:
            result = bsp.process_bound_profile_package(
                convert_segments(parsed['firstSequenceOf87']),
                convert_segments(parsed['sequenceOf88']),
                convert_segments(parsed['secondSequenceOf87']),
                convert_segments(parsed['sequenceOf86'])
            )
