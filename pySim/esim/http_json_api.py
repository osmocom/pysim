...
class JsonHttpApiServer():
    def __init__(self, api_func: JsonHttpApiFunction):
        self.api_func = api_func

    def response(self, data: dict, fe_status: str, request: Request) -> dict:
        ...
        # In case a function execution status is provided, use it to generate and prepend the header field according to
    ...
    def request(self, request: Request) -> dict:
        decoded_json = json.loads(request.content.read())
        return self.api_func.decode_server(decoded_json)
